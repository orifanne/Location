...
public class ImagePanel extends JPanel {
	...
	/**
	 * Отрисовывает внутренние ячейки (внутри области локаци), выделяя их цветом.
	 */
	...
	/**
	 * Отрисовывает линии, образованные всеми абсциссами 
	 * и всеми ординатами концов стен (по которым потом строятся фреймы).
	 */
	...
	/**
	 * Отрисовывает финальные фреймы (прямоугольники, которые разбиваются на конечные ячейки).
	 */
